...
impl SseOpcode {
    ...
    /// Get the memory access size for the opcode
    /// Returns `None` if the size cannot be known without more information (e.g. cvt opcodes)
    pub(crate) fn mem_access_size(&self) -> Option<u8> {
        match self {
            SseOpcode::Addps => Some(16),
            SseOpcode::Addpd => Some(16),
            SseOpcode::Addss => Some(4),
            SseOpcode::Addsd => Some(8),
            SseOpcode::Andps => Some(16),
            SseOpcode::Andpd => Some(16),
            SseOpcode::Andnps => Some(16),
            SseOpcode::Andnpd => Some(16),
            SseOpcode::Blendvpd => Some(16),
            SseOpcode::Blendvps => Some(16),
            SseOpcode::Comiss => Some(4),
            SseOpcode::Comisd => Some(8),
            SseOpcode::Cmpps => Some(16),
            SseOpcode::Cmppd => Some(16),
            SseOpcode::Cmpss => Some(4),
            SseOpcode::Cmpsd => Some(8),
            SseOpcode::Cvtdq2ps => None,
            SseOpcode::Cvtdq2pd => None,
            SseOpcode::Cvtpd2ps => None,
            SseOpcode::Cvtps2pd => None,
            SseOpcode::Cvtsd2ss => None,
            SseOpcode::Cvtsd2si => None,
            SseOpcode::Cvtsi2ss => None,
            SseOpcode::Cvtsi2sd => None,
            SseOpcode::Cvtss2si => None,
            SseOpcode::Cvtss2sd => None,
            SseOpcode::Cvttpd2dq => None,
            SseOpcode::Cvttps2dq => None,
            SseOpcode::Cvttss2si => None,
            SseOpcode::Cvttsd2si => None,
            SseOpcode::Divps => Some(16),
            SseOpcode::Divpd => Some(16),
            SseOpcode::Divss => Some(4),
            SseOpcode::Divsd => Some(8),
            SseOpcode::Insertps => Some(16),
            SseOpcode::Maxps => Some(16),
            SseOpcode::Maxpd => Some(16),
            SseOpcode::Maxss => Some(4),
            SseOpcode::Maxsd => Some(8),
            SseOpcode::Minps => Some(16),
            SseOpcode::Minpd => Some(16),
            SseOpcode::Minss => Some(4),
            SseOpcode::Minsd => Some(8),
            SseOpcode::Movaps => Some(16),
            SseOpcode::Movapd => Some(16),
            SseOpcode::Movd => Some(4),
            SseOpcode::Movdqa => Some(16),
            SseOpcode::Movdqu => Some(16),
            SseOpcode::Movlhps => Some(16),
            SseOpcode::Movmskps => Some(16),
            SseOpcode::Movmskpd => Some(16),
            SseOpcode::Movq => Some(8),
            SseOpcode::Movss => Some(4),
            SseOpcode::Movsd => Some(8),
            SseOpcode::Movups => Some(16),
            SseOpcode::Movupd => Some(16),
            SseOpcode::Mulps => Some(16),
            SseOpcode::Mulpd => Some(16),
            SseOpcode::Mulss => Some(4),
            SseOpcode::Mulsd => Some(8),
            SseOpcode::Orps => Some(16),
            SseOpcode::Orpd => Some(16),
            SseOpcode::Pabsb => Some(16),
            SseOpcode::Pabsw => Some(16),
            SseOpcode::Pabsd => Some(8),
            SseOpcode::Packssdw => Some(16),
            SseOpcode::Packsswb => Some(16),
            SseOpcode::Packusdw => Some(16),
            SseOpcode::Packuswb => Some(16),
            SseOpcode::Paddb => Some(16),
            SseOpcode::Paddd => Some(16),
            SseOpcode::Paddq => Some(16),
            SseOpcode::Paddw => Some(16),
            SseOpcode::Paddsb => Some(16),
            SseOpcode::Paddsw => Some(16),
            SseOpcode::Paddusb => Some(16),
            SseOpcode::Paddusw => Some(16),
            SseOpcode::Palignr => Some(16),
            SseOpcode::Pand => Some(16),
            SseOpcode::Pandn => Some(16),
            SseOpcode::Pavgb => Some(16),
            SseOpcode::Pavgw => Some(16),
            SseOpcode::Pblendvb => Some(16),
            SseOpcode::Pcmpeqb => Some(16),
            SseOpcode::Pcmpeqw => Some(16),
            SseOpcode::Pcmpeqd => Some(16),
            SseOpcode::Pcmpeqq => Some(16),
            SseOpcode::Pcmpgtb => Some(16),
            SseOpcode::Pcmpgtw => Some(16),
            SseOpcode::Pcmpgtd => Some(16),
            SseOpcode::Pcmpgtq => Some(16),
            SseOpcode::Pextrb => Some(16),
            SseOpcode::Pextrw => Some(16),
            SseOpcode::Pextrd => Some(16),
            SseOpcode::Pextrq => Some(16),
            SseOpcode::Pinsrb => Some(16),
            SseOpcode::Pinsrw => Some(16),
            SseOpcode::Pinsrd => Some(16),
            SseOpcode::Pmaddubsw => Some(16),
            SseOpcode::Pmaddwd => Some(16),
            SseOpcode::Pmaxsb => Some(16),
            SseOpcode::Pmaxsw => Some(16),
            SseOpcode::Pmaxsd => Some(16),
            SseOpcode::Pmaxub => Some(16),
            SseOpcode::Pmaxuw => Some(16),
            SseOpcode::Pmaxud => Some(16),
            SseOpcode::Pminsb => Some(16),
            SseOpcode::Pminsw => Some(16),
            SseOpcode::Pminsd => Some(16),
            SseOpcode::Pminub => Some(16),
            SseOpcode::Pminuw => Some(16),
            SseOpcode::Pminud => Some(16),
            SseOpcode::Pmovmskb => Some(16),
            SseOpcode::Pmovsxbd => Some(16),
            SseOpcode::Pmovsxbw => Some(16),
            SseOpcode::Pmovsxbq => Some(16),
            SseOpcode::Pmovsxwd => Some(16),
            SseOpcode::Pmovsxwq => Some(16),
            SseOpcode::Pmovsxdq => Some(16),
            SseOpcode::Pmovzxbd => Some(16),
            SseOpcode::Pmovzxbw => Some(16),
            SseOpcode::Pmovzxbq => Some(16),
            SseOpcode::Pmovzxwd => Some(16),
            SseOpcode::Pmovzxwq => Some(16),
            SseOpcode::Pmovzxdq => Some(16),
            SseOpcode::Pmuldq => Some(16),
            SseOpcode::Pmulhw => Some(16),
            SseOpcode::Pmulhuw => Some(16),
            SseOpcode::Pmulhrsw => Some(16),
            SseOpcode::Pmulld => Some(16),
            SseOpcode::Pmullw => Some(16),
            SseOpcode::Pmuludq => Some(16),
            SseOpcode::Por => Some(16),
            SseOpcode::Pshufb => Some(16),
            SseOpcode::Pshufd => Some(16),
            SseOpcode::Psllw => Some(16),
            SseOpcode::Pslld => Some(16),
            SseOpcode::Psllq => Some(16),
            SseOpcode::Psraw => Some(16),
            SseOpcode::Psrad => Some(16),
            SseOpcode::Psrlw => Some(16),
            SseOpcode::Psrld => Some(16),
            SseOpcode::Psrlq => Some(16),
            SseOpcode::Psubb => Some(16),
            SseOpcode::Psubd => Some(16),
            SseOpcode::Psubq => Some(16),
            SseOpcode::Psubw => Some(16),
            SseOpcode::Psubsb => Some(16),
            SseOpcode::Psubsw => Some(16),
            SseOpcode::Psubusb => Some(16),
            SseOpcode::Psubusw => Some(16),
            SseOpcode::Ptest => Some(16),
            SseOpcode::Punpckhbw => Some(16),
            SseOpcode::Punpckhwd => Some(16),
            SseOpcode::Punpcklbw => Some(16),
            SseOpcode::Punpcklwd => Some(16),
            SseOpcode::Pxor => Some(16),
            SseOpcode::Rcpss => Some(4),
            SseOpcode::Roundps => Some(16),
            SseOpcode::Roundpd => Some(16),
            SseOpcode::Roundss => Some(4),
            SseOpcode::Roundsd => Some(8),
            SseOpcode::Rsqrtss => Some(4),
            SseOpcode::Shufps => Some(16),
            SseOpcode::Sqrtps => Some(16),
            SseOpcode::Sqrtpd => Some(16),
            SseOpcode::Sqrtss => Some(4),
            SseOpcode::Sqrtsd => Some(8),
            SseOpcode::Subps => Some(16),
            SseOpcode::Subpd => Some(16),
            SseOpcode::Subss => Some(4),
            SseOpcode::Subsd => Some(8),
            SseOpcode::Ucomiss => Some(4),
            SseOpcode::Ucomisd => Some(8),
            SseOpcode::Unpcklps => Some(16),
            SseOpcode::Unpckhps => Some(16),
            SseOpcode::Xorps => Some(16),
            SseOpcode::Xorpd => Some(16),
            SseOpcode::Phaddw => Some(16),
            SseOpcode::Phaddd => Some(16),
            SseOpcode::Punpckhdq => Some(16),
            SseOpcode::Punpckldq => Some(16),
            SseOpcode::Punpckhqdq => Some(16),
            SseOpcode::Punpcklqdq => Some(16),
            SseOpcode::Pshuflw => Some(16),
            SseOpcode::Pshufhw => Some(16),
            SseOpcode::Pblendw => Some(16),
            SseOpcode::Movddup => Some(8),
        }
    }
}
...
impl AvxOpcode {
    ...
    /// Returns `None` if the size cannot be known without more information (e.g. cvt opcodes)
    pub(crate) fn mem_access_size(&self) -> Option<u8> {
        const MAX_SIZE: u8 = 16; // currently, no 32 byte wide insts are generated
        match self {
            AvxOpcode::Vfmadd213ss => Some(4),
            AvxOpcode::Vfmadd213sd => Some(8),
            AvxOpcode::Vfmadd213ps => Some(MAX_SIZE),
            AvxOpcode::Vfmadd213pd => Some(MAX_SIZE),
            AvxOpcode::Vfmadd132ss => Some(4),
            AvxOpcode::Vfmadd132sd => Some(8),
            AvxOpcode::Vfmadd132ps => Some(MAX_SIZE),
            AvxOpcode::Vfmadd132pd => Some(MAX_SIZE),
            AvxOpcode::Vfnmadd213ss => Some(4),
            AvxOpcode::Vfnmadd213sd => Some(8),
            AvxOpcode::Vfnmadd213ps => Some(MAX_SIZE),
            AvxOpcode::Vfnmadd213pd => Some(MAX_SIZE),
            AvxOpcode::Vfnmadd132ss => Some(4),
            AvxOpcode::Vfnmadd132sd => Some(8),
            AvxOpcode::Vfnmadd132ps => Some(MAX_SIZE),
            AvxOpcode::Vfnmadd132pd => Some(MAX_SIZE),
            AvxOpcode::Vcmpps => Some(MAX_SIZE),
            AvxOpcode::Vcmppd => Some(MAX_SIZE),
            AvxOpcode::Vpsrlw => Some(MAX_SIZE),
            AvxOpcode::Vpsrld => Some(MAX_SIZE),
            AvxOpcode::Vpsrlq => Some(MAX_SIZE),
            AvxOpcode::Vpaddb => Some(MAX_SIZE),
            AvxOpcode::Vpaddw => Some(MAX_SIZE),
            AvxOpcode::Vpaddd => Some(MAX_SIZE),
            AvxOpcode::Vpaddq => Some(MAX_SIZE),
            AvxOpcode::Vpaddsb => Some(MAX_SIZE),
            AvxOpcode::Vpaddsw => Some(MAX_SIZE),
            AvxOpcode::Vpaddusb => Some(MAX_SIZE),
            AvxOpcode::Vpaddusw => Some(MAX_SIZE),
            AvxOpcode::Vpsubb => Some(MAX_SIZE),
            AvxOpcode::Vpsubw => Some(MAX_SIZE),
            AvxOpcode::Vpsubd => Some(MAX_SIZE),
            AvxOpcode::Vpsubq => Some(MAX_SIZE),
            AvxOpcode::Vpsubsb => Some(MAX_SIZE),
            AvxOpcode::Vpsubsw => Some(MAX_SIZE),
            AvxOpcode::Vpsubusb => Some(MAX_SIZE),
            AvxOpcode::Vpsubusw => Some(MAX_SIZE),
            AvxOpcode::Vpavgb => Some(MAX_SIZE),
            AvxOpcode::Vpavgw => Some(MAX_SIZE),
            AvxOpcode::Vpand => Some(MAX_SIZE),
            AvxOpcode::Vandps => Some(MAX_SIZE),
            AvxOpcode::Vandpd => Some(MAX_SIZE),
            AvxOpcode::Vpor => Some(MAX_SIZE),
            AvxOpcode::Vorps => Some(MAX_SIZE),
            AvxOpcode::Vorpd => Some(MAX_SIZE),
            AvxOpcode::Vpxor => Some(MAX_SIZE),
            AvxOpcode::Vxorps => Some(MAX_SIZE),
            AvxOpcode::Vxorpd => Some(MAX_SIZE),
            AvxOpcode::Vpmullw => Some(MAX_SIZE),
            AvxOpcode::Vpmulld => Some(MAX_SIZE),
            AvxOpcode::Vpmulhw => Some(MAX_SIZE),
            AvxOpcode::Vpmulhd => Some(MAX_SIZE),
            AvxOpcode::Vpmulhrsw => Some(MAX_SIZE),
            AvxOpcode::Vpmulhuw => Some(MAX_SIZE),
            AvxOpcode::Vpmuldq => Some(MAX_SIZE),
            AvxOpcode::Vpmuludq => Some(MAX_SIZE),
            AvxOpcode::Vpunpckhwd => Some(MAX_SIZE),
            AvxOpcode::Vpunpcklwd => Some(MAX_SIZE),
            AvxOpcode::Vunpcklps => Some(MAX_SIZE),
            AvxOpcode::Vunpckhps => Some(MAX_SIZE),
            AvxOpcode::Vandnps => Some(MAX_SIZE),
            AvxOpcode::Vandnpd => Some(MAX_SIZE),
            AvxOpcode::Vpandn => Some(MAX_SIZE),
            AvxOpcode::Vaddps => Some(MAX_SIZE),
            AvxOpcode::Vaddpd => Some(MAX_SIZE),
            AvxOpcode::Vsubps => Some(MAX_SIZE),
            AvxOpcode::Vsubpd => Some(MAX_SIZE),
            AvxOpcode::Vmulps => Some(MAX_SIZE),
            AvxOpcode::Vmulpd => Some(MAX_SIZE),
            AvxOpcode::Vdivps => Some(MAX_SIZE),
            AvxOpcode::Vdivpd => Some(MAX_SIZE),
            AvxOpcode::Vpcmpeqb => Some(MAX_SIZE),
            AvxOpcode::Vpcmpeqw => Some(MAX_SIZE),
            AvxOpcode::Vpcmpeqd => Some(MAX_SIZE),
            AvxOpcode::Vpcmpeqq => Some(MAX_SIZE),
            AvxOpcode::Vpcmpgtb => Some(MAX_SIZE),
            AvxOpcode::Vpcmpgtw => Some(MAX_SIZE),
            AvxOpcode::Vpcmpgtd => Some(MAX_SIZE),
            AvxOpcode::Vpcmpgtq => Some(MAX_SIZE),
            AvxOpcode::Vminps => Some(MAX_SIZE),
            AvxOpcode::Vminpd => Some(MAX_SIZE),
            AvxOpcode::Vmaxps => Some(MAX_SIZE),
            AvxOpcode::Vmaxpd => Some(MAX_SIZE),
            AvxOpcode::Vblendvpd => Some(MAX_SIZE),
            AvxOpcode::Vblendvps => Some(MAX_SIZE),
            AvxOpcode::Vpblendvb => Some(MAX_SIZE),
            AvxOpcode::Vmovlhps => Some(MAX_SIZE),
            AvxOpcode::Vpmaxsb => Some(MAX_SIZE),
            AvxOpcode::Vpmaxsw => Some(MAX_SIZE),
            AvxOpcode::Vpmaxsd => Some(MAX_SIZE),
            AvxOpcode::Vpminsb => Some(MAX_SIZE),
            AvxOpcode::Vpminsw => Some(MAX_SIZE),
            AvxOpcode::Vpminsd => Some(MAX_SIZE),
            AvxOpcode::Vpmaxub => Some(MAX_SIZE),
            AvxOpcode::Vpmaxuw => Some(MAX_SIZE),
            AvxOpcode::Vpmaxud => Some(MAX_SIZE),
            AvxOpcode::Vpminub => Some(MAX_SIZE),
            AvxOpcode::Vpminuw => Some(MAX_SIZE),
            AvxOpcode::Vpminud => Some(MAX_SIZE),
            AvxOpcode::Vpunpcklbw => Some(MAX_SIZE),
            AvxOpcode::Vpunpckhbw => Some(MAX_SIZE),
            AvxOpcode::Vpacksswb => Some(MAX_SIZE),
            AvxOpcode::Vpackssdw => Some(MAX_SIZE),
            AvxOpcode::Vpackuswb => Some(MAX_SIZE),
            AvxOpcode::Vpackusdw => Some(MAX_SIZE),
            AvxOpcode::Vpalignr => Some(MAX_SIZE),
            AvxOpcode::Vpinsrb => Some(MAX_SIZE),
            AvxOpcode::Vpinsrw => Some(MAX_SIZE),
            AvxOpcode::Vpinsrd => Some(MAX_SIZE),
            AvxOpcode::Vpinsrq => Some(MAX_SIZE),
            AvxOpcode::Vpmaddwd => Some(MAX_SIZE),
            AvxOpcode::Vpmaddubsw => Some(MAX_SIZE),
            AvxOpcode::Vinsertps => Some(MAX_SIZE),
            AvxOpcode::Vpshufb => Some(MAX_SIZE),
            AvxOpcode::Vshufps => Some(MAX_SIZE),
            AvxOpcode::Vpsllw => Some(MAX_SIZE),
            AvxOpcode::Vpslld => Some(MAX_SIZE),
            AvxOpcode::Vpsllq => Some(MAX_SIZE),
            AvxOpcode::Vpsraw => Some(MAX_SIZE),
            AvxOpcode::Vpsrad => Some(MAX_SIZE),
            AvxOpcode::Vpmovsxbw => Some(MAX_SIZE),
            AvxOpcode::Vpmovzxbw => Some(MAX_SIZE),
            AvxOpcode::Vpmovsxwd => Some(MAX_SIZE),
            AvxOpcode::Vpmovzxwd => Some(MAX_SIZE),
            AvxOpcode::Vpmovsxdq => Some(MAX_SIZE),
            AvxOpcode::Vpmovzxdq => Some(MAX_SIZE),
            AvxOpcode::Vaddss => Some(4),
            AvxOpcode::Vaddsd => Some(8),
            AvxOpcode::Vmulss => Some(4),
            AvxOpcode::Vmulsd => Some(8),
            AvxOpcode::Vsubss => Some(4),
            AvxOpcode::Vsubsd => Some(8),
            AvxOpcode::Vdivss => Some(4),
            AvxOpcode::Vdivsd => Some(8),
            AvxOpcode::Vpabsb => Some(MAX_SIZE),
            AvxOpcode::Vpabsw => Some(MAX_SIZE),
            AvxOpcode::Vpabsd => Some(MAX_SIZE),
            AvxOpcode::Vminss => Some(4),
            AvxOpcode::Vminsd => Some(8),
            AvxOpcode::Vmaxss => Some(4),
            AvxOpcode::Vmaxsd => Some(8),
            AvxOpcode::Vsqrtps => Some(MAX_SIZE),
            AvxOpcode::Vsqrtpd => Some(MAX_SIZE),
            AvxOpcode::Vroundps => Some(MAX_SIZE),
            AvxOpcode::Vroundpd => Some(MAX_SIZE),
            AvxOpcode::Vcvtdq2pd => None,
            AvxOpcode::Vcvtdq2ps => None,
            AvxOpcode::Vcvtpd2ps => None,
            AvxOpcode::Vcvtps2pd => None,
            AvxOpcode::Vcvttpd2dq => None,
            AvxOpcode::Vcvttps2dq => None,
            AvxOpcode::Vphaddw => Some(MAX_SIZE),
            AvxOpcode::Vphaddd => Some(MAX_SIZE),
            AvxOpcode::Vpunpckhdq => Some(MAX_SIZE),
            AvxOpcode::Vpunpckldq => Some(MAX_SIZE),
            AvxOpcode::Vpunpckhqdq => Some(MAX_SIZE),
            AvxOpcode::Vpunpcklqdq => Some(MAX_SIZE),
            AvxOpcode::Vpshuflw => Some(MAX_SIZE),
            AvxOpcode::Vpshufhw => Some(MAX_SIZE),
            AvxOpcode::Vpshufd => Some(MAX_SIZE),
            AvxOpcode::Vmovss => Some(4),
            AvxOpcode::Vmovsd => Some(8),
            AvxOpcode::Vmovups => Some(MAX_SIZE),
            AvxOpcode::Vmovupd => Some(MAX_SIZE),
            AvxOpcode::Vmovdqu => Some(MAX_SIZE),
            AvxOpcode::Vpextrb => Some(MAX_SIZE),
            AvxOpcode::Vpextrw => Some(MAX_SIZE),
            AvxOpcode::Vpextrd => Some(MAX_SIZE),
            AvxOpcode::Vpextrq => Some(MAX_SIZE),
            AvxOpcode::Vpblendw => Some(MAX_SIZE),
            AvxOpcode::Vmovddup => None, // could be either 256 or 64
            AvxOpcode::Vpbroadcastb => Some(MAX_SIZE),
            AvxOpcode::Vpbroadcastw => Some(MAX_SIZE),
            AvxOpcode::Vpbroadcastd => Some(MAX_SIZE),
            AvxOpcode::Vbroadcastss => Some(4),
            AvxOpcode::Vmovd => Some(4),
            AvxOpcode::Vmovq => Some(8),
            AvxOpcode::Vmovmskps => Some(MAX_SIZE),
            AvxOpcode::Vmovmskpd => Some(MAX_SIZE),
            AvxOpcode::Vpmovmskb => Some(MAX_SIZE),
            AvxOpcode::Vcvtsi2ss => Some(4),
            AvxOpcode::Vcvtsi2sd => Some(8),
            AvxOpcode::Vcvtss2sd => Some(4),
            AvxOpcode::Vcvtsd2ss => Some(8),
            AvxOpcode::Vsqrtss => Some(4),
            AvxOpcode::Vsqrtsd => Some(8),
            AvxOpcode::Vroundss => Some(4),
            AvxOpcode::Vroundsd => Some(8),
        }
    }
}
...
impl Avx512Opcode {
    ...
    /// Returns `None` if the size cannot be known without more information (e.g. cvt opcodes)
    pub(crate) fn mem_access_size(&self) -> Option<u8> {
        const MAX_SIZE: u8 = 16; // currently, no 64 byte wide insts are generated
        match self {
            Avx512Opcode::Vcvtudq2ps => None,
            Avx512Opcode::Vpabsq => Some(MAX_SIZE),
            Avx512Opcode::Vpermi2b => Some(MAX_SIZE),
            Avx512Opcode::Vpmullq => Some(MAX_SIZE),
            Avx512Opcode::Vpopcntb => Some(MAX_SIZE),
            Avx512Opcode::Vpsraq => Some(MAX_SIZE),
            Avx512Opcode::VpsraqImm => Some(MAX_SIZE),
        }
    }
}
